...
* Run <pre><code> bash 6_run_quantum_models.sh -m alpha_3_multiclass -d PATH_TO_TRAIN -v PATH_TO_TEST -p Adam -x 42 -r 1 -i 10 -u 4 -s 0.01 -b 2048 -l 0.002 -w 0 -z 150 -g 1 -o ./benchmarking/results/raw/  </pre></code>
...
* Position yourself at the root of the directory.
* Navigate to `neasqc_wp61` by using <pre><code> cd neasqc_wp61 </code></pre>
* Run <pre><code> bash 6_run_quantum_models.sh -m beta_2_tests -d PATH_TO_TRAIN -v PATH_TO_TEST -p Adam -x 42 -r 1 -i 10 -u 8 -s 0.01 -b 2048 -l 0.002 -w 0 -z 150 -g 1 -o ./benchmarking/results/raw  </pre></code>
...
<!--- Runs... but are they the right files?
bash 6_run_quantum_models.sh -m beta_2_tests -d data/datasets/agnews_balanced_test_bert_pca.csv -v data/datasets/agnews_balanced_test_bert_pca.csv -p Adam -x 42 -r 1 -i 10 -u 8 -s 0.01 -b 2048 -l 0.002 -w 0 -z 150 -g 1 -o ./benchmarking/results/raw
--->
...
#### Cross-validation example
* From the root of the directory, navigate to `neasqc_wp61` by using: <pre><code>cd neasqc_wp61</code></pre>
* Run <pre><code> bash 6_run_quantum_models.sh -m beta_2 -d PATH_TO_TRAIN -v PATH_TO_TEST -p Adam -x 42 -r 1 -i 10 -u 8 -s 0.01 -b 2048 -l 0.002 -w 0 -z 150 -g 1 -o ./benchmarking/results/raw  </pre></code>
...
* Position yourself at the root of the directory.
* Navigate to `neasqc_wp61` by using <pre><code> cd neasqc_wp61 </code></pre>
* Run <pre><code> bash 6_run_quantum_models.sh -m beta_3_tests -d PATH_TO_TRAIN -v PATH_TO_TEST -p Adam -x 42 -r 1 -i 10 -u 8 -s 0.01 -b 2048 -l 0.002 -w 0 -z 150 -g 1 -o ./benchmarking/results/raw  </pre></code>
...
```
bash 6_run_quantum_models.sh -m beta_3 -d PATH_TO_TRAIN -v PATH_TO_TEST -p Adam -x 42 -r 1 -i 10 -u 8 -s 0.01 -b 2048 -l 0.002 -w 0 -z 150 -g 1 -o ./benchmarking/results/raw
```
